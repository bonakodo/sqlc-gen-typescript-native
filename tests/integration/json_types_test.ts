import type {
  ...
  JsonObject,
  JsonValue,
} from "./.generated/node-pg/wasm/index.ts";
import type { GetRecordRow } from "./.generated/node-pg/wasm/query_sql.ts";
import type { GetRecordRow as CustomRow } from "./.generated/json-custom/wasm/query_sql.ts";
import type { GetRecordRow as TypesOnlyRow } from "./.generated/json-types-only/wasm/query_sql.ts";
